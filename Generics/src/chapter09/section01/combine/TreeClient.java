...
class TreeClient {
    ...
    final static Tree.Visitor<Integer, Double> SUM_VISITOR = new Tree.Visitor<Integer, Double>() {

        public Double leaf(Integer e) {
            return e.doubleValue();
        }
    ...
    public static void main(String[] args) {
        ...
        // or
        System.out.println("combine visitors and simple: " + t + "; sum() = " + t.visit(SUM_VISITOR));
