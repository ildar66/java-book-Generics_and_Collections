package chapter03.section03.permit;
...
class Test {
    ...
    public static void main(String... args) {
        ...
        assert generics.Comparators.max(fruits).equals(new Orange(10));  // ok
        ...
        System.out.println("generics.Comparators.max(fruits) = " + generics.Comparators.max(fruits));
