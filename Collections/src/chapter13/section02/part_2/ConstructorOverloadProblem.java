...
public class ConstructorOverloadProblem {
    ...
    public static void main(String[] args) {
        // construct and populate a NavigableSet whose iterator returns its elements in the reverse of natural order:
        NavigableSet<String> base = new TreeSet<String>(Collections.reverseOrder());
        Collections.addAll(base, "b", "a", "c");

        // call the two different constructors for TreeSet, supplying the set just constructed, but with different static types:
